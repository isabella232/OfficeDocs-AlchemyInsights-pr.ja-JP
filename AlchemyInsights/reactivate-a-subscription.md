...
---
# <a name="reactivate-a-microsoft-365-subscription"></a>Microsoft 365 サブスクリプションを再度有効にする
...
2. 再アクティブ化するサブスクリプションを選択します。 [課金] セクションで、[**再アクティブ化**] を選択します。
    ...
    実行できる操作として [**再アクティブ化**] が表示されていない場合、[電話でサポートに連絡](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products)して、サブスクリプションのライセンスの再認証を依頼してください。
