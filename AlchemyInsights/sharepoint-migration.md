...
- 「[データ移行と SPO サービスの調整](https://blogs.technet.microsoft.com/sposupport/2017/08/12/data-migration-and-spo-service-throttling/)」。
...
**注**: 現在、SharePoint 移行ツールでは、SharePoint 2010 および 2013 からの移行のみがサポートされています。 現時点では、バージョン 2016 または 2019 のサポートはされていません。
