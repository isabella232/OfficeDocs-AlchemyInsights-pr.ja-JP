...
---
# <a name="terms-missing-from-sharepoint-online-term-store"></a>SharePoint Online 用語ストアで用語が見つからない

表示されるはずの SharePoint Online 用語ストア内の用語が表示されないか、または断続的にしか表示されません。
