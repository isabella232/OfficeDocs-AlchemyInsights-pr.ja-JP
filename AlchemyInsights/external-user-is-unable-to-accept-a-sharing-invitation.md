...
ms.locfileid: "37769128"
---
# <a name="external-user-is-unable-to-accept-a-sharing-invitation"></a>外部連絡先が、共有の招待を承諾することができない

外部ユーザーが SharePoint または OneDrive の共有の招待を承諾できない場合は、下記のリンクにアクセスしてみてください。 
