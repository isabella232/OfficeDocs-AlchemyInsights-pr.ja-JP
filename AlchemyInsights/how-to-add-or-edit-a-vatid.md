...
> [!NOTE]
> 付加価値税 (VAT) が通用している国 (イギリスなど) では、Microsoft Invoicing は VAT を計算して、その金額を請求書に適用します。 詳細については、欧州委員会による「[VIES 免責](https://go.microsoft.com/fwlink/p/?LinkID=841741)」を参照してください。
