...
2. プロダクト キーを入力し、メッセージに従ってサブスクリプションをアクティブ化します。アクティブ化に問題がある場合は、この[一般的なプロダクト キー エラーと解決策の一覧](https://docs.microsoft.com/office365/admin/misc/product-key-errors-and-solutions)を参照してください。