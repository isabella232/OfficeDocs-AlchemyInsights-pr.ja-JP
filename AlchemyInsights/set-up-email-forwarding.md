...
Office 365 メールボックスのメールの転送設定は、簡単に確認できます。確認するには、次の手順を実行します。
...
古い管理センターを使用している場合 以前の手順または詳細情報については、「[Office 365 でメール転送を構成する](https://docs.microsoft.com/office365/admin/email/configure-email-forwarding)」を参照してください。
...
従業員が退職する場合 推奨される手順については、「[Office 365 から元従業員を削除する](https://docs.microsoft.com/office365/admin/add-users/remove-former-employee)」を参照してください。
