...
- Office の以前のトレースをすべてクリーンアップし、サポート/回復アシスタント (SaRA) を使用して再インストールします。 
    ...
    - SaRA を使用して[Office を再インストール](http://aka.ms/sara-officeinstall)します。 **注**: SaRA を使用して Visio または Project を設定する場合は、[[Visio をインストールする]](https://aka.ms/SaRA-VisioSetupScenario) または [[Project をインストールする]](https://aka.ms/SaRA-ProjectSetupScenario) を使用します。  
