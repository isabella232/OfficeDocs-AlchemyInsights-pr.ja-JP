...
2. ユーザーを追加するプリペイド サブスクリプションを選択します。
    
3. [**その他のアクション**] メニューで [**トークンを使用したライセンスの更新または追加**] を選択します。
    
4. [**新しい未使用プロダクト キー**] を選択します (小売店で購入したプロダクト キーによってこのサブスクリプションが作成された場合、他の支払方法でユーザーを追加できることがあります)。 
    
5. [**次へ**] を選択します。
    
6. プロダクト キーを入力し、[**次へ**] を選択します。
    
7. ユーザーを追加するオプションを選択し、[**次へ**] を選択し、[**使用**] を選択します。
