...
ユーザーにライセンスを割り当てるときに、追加のライセンスを購入する必要があることがわかります。次の操作を行います。
...
詳細については、「 [Microsoft 365 アプリ for business サブスクリプションのライセンスを購入](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/buy-licenses)する」を参照してください。