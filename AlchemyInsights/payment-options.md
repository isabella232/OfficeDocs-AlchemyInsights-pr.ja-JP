...
クレジット カード、銀行口座 (口座振替)、および請求書 (小切手または電子決済支払)
...
現在のサブスクリプションに対する支払い方法を変更する場合は、[ここ](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/change-payment-method?view=o365-worldwide)の手順に従ってください。
  
 **追加情報**
  
[一般法人向け Office 365 サブスクリプションを支払う](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/pay-for-your-subscription?view=o365-worldwide)
