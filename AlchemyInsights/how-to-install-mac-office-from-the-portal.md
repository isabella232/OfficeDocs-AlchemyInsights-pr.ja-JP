...
2. [Office 365 のソフトウェア ダウンロードの設定を管理します](https://docs.microsoft.com/DeployOffice/manage-software-download-settings-office-365)。

3. [ユーザーにライセンスを割り当てます](https://docs.microsoft.com//office365/admin/subscriptions-and-billing/assign-licenses-to-users)。
