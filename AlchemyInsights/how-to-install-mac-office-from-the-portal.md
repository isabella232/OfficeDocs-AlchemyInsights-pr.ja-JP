...
2. [Office 365 でソフトウェアのダウンロード設定を管理](https://docs.microsoft.com/DeployOffice/manage-software-download-settings-office-365)します。

3. [ユーザーにライセンスを割り当て](https://docs.microsoft.com//office365/admin/subscriptions-and-billing/assign-licenses-to-users)ます。
