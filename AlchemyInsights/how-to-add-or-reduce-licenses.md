...
3. **[ライセンスの追加/削除]** をクリックします。

4. 必要なユーザーの合計数を入力します。たとえば、現在 25 個のライセンスがあり、5 個を削除する場合は、このフィールドに「20」と入力します。

5. **[変更の送信]** をクリックします。

**注**: 新しい請求 (ライセンスの増加) またはクレジット (ライセンスの減少) は、次回の請求書に表示されます。
...
- [Microsoft 365 for business のキャンセル](https://support.office.com/article/Cancel-Office-365-for-business-b1bc0bef-4608-4601-813a-cdd9f746709a)

- [別の Microsoft 365 for business サブスクリプションを購入する](https://support.office.com/article/Buy-another-Office-365-for-business-subscription-fab3b86c-3359-4042-8692-5d4dc7550b7c)
