 ...
 **注**: たとえば、サイトの名前を https://contoso.sharepoint.com/sites/sample1 から https://contoso.sharepoint.com/sites/sample2 に変更するには、新しいサイトを作成してから、古いサイトのすべてのコンテンツを新しいサイトに移動します。
