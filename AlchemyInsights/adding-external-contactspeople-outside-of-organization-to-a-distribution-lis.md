...
---
# <a name="add-external-email-addresses-to-a-distribution-group"></a><span data-ttu-id="26127-102">配布グループに外部のメール アドレスを追加する</span><span class="sxs-lookup"><span data-stu-id="26127-102">Add external email addresses to a distribution group</span></span>
