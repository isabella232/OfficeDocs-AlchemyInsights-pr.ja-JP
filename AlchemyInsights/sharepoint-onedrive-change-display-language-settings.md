...
ms.locfileid: "40051394"
---
# <a name="change-display-language-settings-in-sharepoint-or-onedrive"></a>SharePoint または OneDrive の表示言語の設定を変更する 

SharePoint または OneDrive の既定の言語設定は、Office 365 サブスクリプションの作成時に定義されるために変更できません。 ただし、表示言語の設定は変更できます。
...
言語設定のトラブルシューティングの詳細については、「[SharePoint Online サイト コレクションの既定の言語が変更できない](https://docs.microsoft.com/sharepoint/support/sites/change-default-language-site-collection)」を参照してください。
