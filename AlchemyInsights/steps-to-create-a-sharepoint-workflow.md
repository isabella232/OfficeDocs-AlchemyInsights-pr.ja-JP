...
- SharePoint 2010 承認ワークフローを追加できない場合は、「[既定の2010承認ワークフローを追加できませ](https://docs.microsoft.com/alchemyinsights/can-t-add-default-2010-approval-workflow)ん」を参照してください。
- ワークフローを作成する方法:
