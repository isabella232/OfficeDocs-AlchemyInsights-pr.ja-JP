...
**注意**: Teams の会議記録機能は、地域や国での Stream の提供状況に依存しています。 会議を記録できない場合は、「[Microsoft Stream は、どの地域にデータをホストしますか](https://docs.microsoft.com/stream/faq#which-regions-does-microsoft-stream-host-my-data-in)」を参照してください。 
