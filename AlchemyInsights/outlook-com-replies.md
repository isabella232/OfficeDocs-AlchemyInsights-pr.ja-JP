...
**[設定** > **] Outlook のすべての設定** > **メール** > の**自動応答**を表示して、[自動応答の設定](https://outlook.live.com/mail/options/mail/automaticReplies)を開きます。
2. [**自動応答の有効化**] を選択します。
