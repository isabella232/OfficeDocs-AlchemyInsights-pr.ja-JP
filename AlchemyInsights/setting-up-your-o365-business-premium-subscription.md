...
Microsoft 365 サブスクリプションをセットアップするのにサポートが必要な場合は、[この記事](https://docs.microsoft.com/office365/admin/setup/setup?view=o365-worldwide&tabs=BusPremium)の手順に従って、セットアップを完了します。
