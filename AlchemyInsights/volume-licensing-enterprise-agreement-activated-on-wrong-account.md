...
**ボリュームライセンスエンタープライズ契約** を利用して購入したサブスクリプションを見つけた場合に、**間違ったテナント** でライセンス認証された、あるテナントから別のテナントに **ライセンスを転送** する方法は [サポートにお問い合わせ](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products)ください。