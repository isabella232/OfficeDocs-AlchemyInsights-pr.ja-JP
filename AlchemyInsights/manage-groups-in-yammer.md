...
- **グループ作成の権限。** Yammer では、グループを作成できるユーザーを制御することはできません。 ただし、接続されている Microsoft 365 グループのグループ作成は管理することができます。 詳細については、「[Microsoft 365 グループを作成できるユーザーを管理する](https://docs.microsoft.com/microsoft-365/admin/create-groups/manage-creation-of-groups)」を参照してください。
