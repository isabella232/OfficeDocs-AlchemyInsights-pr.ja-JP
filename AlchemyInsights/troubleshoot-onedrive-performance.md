...
---
# <a name="troubleshoot-onedrive-performance"></a><span data-ttu-id="57b55-102">OneDrive のパフォーマンスのトラブルシューティング</span><span class="sxs-lookup"><span data-stu-id="57b55-102">Troubleshoot OneDrive performance</span></span>

<span data-ttu-id="57b55-103">予想よりも遅い同期が発生している場合、または OneDrive に同様のパフォーマンスの問題が発生している場合:</span><span class="sxs-lookup"><span data-stu-id="57b55-103">If you’re experiencing a slower than expected sync, or similar performance issues with OneDrive:</span></span>
