...
---
# <a name="error-while-activation-office-2013-on-remote-desktop-services"></a>リモートデスクトップサービスでのライセンス認証 Office 2013 のエラー

リモート デスクトップ サービス (RDS) 展開上で Office 2013 のライセンス認証中にエラーを受信した場合は、レジストリを編集して ADAL を有効にすることを検討します。
  
|**レジストリ キー**|**Type**|**値**|
|:-----|:-----|:-----|
|HKEY_CURRENT_USER\Software\Microsoft\Office\15.0\Common\Identity\EnableADAL  <br/> |REG_DWORD  <br/> |1-d  <br/> |
...
> [!NOTE]
>  ADAL は、Office 365 ProPlus および Office 2016 では既定で有効になっています。 リモートデスクトップサービス (RDS) は、以前はターミナルサービスと呼ばれていました。
