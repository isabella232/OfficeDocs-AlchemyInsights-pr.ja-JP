...
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>ファイル エクスプ ローラーで SharePoint ライブラリを開く

1. Internet Explorer 10 または 11 の Internet Explorer では、ライブラリを参照します。 
    
2. 右上の表示アイコンをクリックし、**ファイル エクスプ ローラー ビュー**] をクリックします。
