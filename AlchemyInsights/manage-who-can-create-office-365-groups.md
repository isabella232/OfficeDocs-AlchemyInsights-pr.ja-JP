...
既定では、組織内のすべてのユーザーが O365 グループを作成できます。
  
これを変更する場合は、PowerShell を使用して、グループの作成を一部のユーザーに限定するセキュリティ グループを作成できます。
  
「[Microsoft 365 グループを作成できるユーザーを管理する](https://docs.microsoft.com/microsoft-365/admin/create-groups/manage-creation-of-groups)」の詳しい手順に従って操作します。
