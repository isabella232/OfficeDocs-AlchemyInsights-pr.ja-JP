...
ms.locfileid: "36507168"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="331f0-102">[Domains] ページにアクセスする</span><span class="sxs-lookup"><span data-stu-id="331f0-102">Access the Domains Page</span></span>

<span data-ttu-id="331f0-103">[ドメイン] ページにアクセスするには、次のアイコンをクリックします。</span><span class="sxs-lookup"><span data-stu-id="331f0-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="331f0-104">ドメインの追加、変更、または削除を行うことができます。</span><span class="sxs-lookup"><span data-stu-id="331f0-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="331f0-105">詳細については、「[ドメインに関する FAQ](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="331f0-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
