...
ms.locfileid: "44505060"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="adfb2-102">[Domains] ページにアクセスする</span><span class="sxs-lookup"><span data-stu-id="adfb2-102">Access the Domains Page</span></span>

<span data-ttu-id="adfb2-103">[Domains] ページにアクセスするには、下記のこのアイコンをクリックします。</span><span class="sxs-lookup"><span data-stu-id="adfb2-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="adfb2-104">ドメインの追加、変更、または削除を行うことができます。</span><span class="sxs-lookup"><span data-stu-id="adfb2-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="adfb2-105">詳細については、「[ドメインに関する FAQ](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="adfb2-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
