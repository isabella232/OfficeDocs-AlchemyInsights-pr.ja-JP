...
- [機密情報の種類で検索される情報](https://docs.microsoft.com/microsoft-365/compliance/sensitive-information-type-entity-definitions)
- [カスタムの機密情報の種類を作成する](https://docs.microsoft.com/microsoft-365/compliance/create-a-custom-sensitive-information-type)
- [メール通知を送信し、ポリシー ヒントを表示する](https://docs.microsoft.com/microsoft-365/compliance/use-notifications-and-policy-tips)
- [保持ラベルと DLP により SharePoint Online ファイルを保護する](https://docs.microsoft.com/microsoft-365/compliance/protect-sharepoint-online-files-with-office-365-labels-and-dlp)
- [DLP と Microsoft Teams](https://docs.microsoft.com/microsoft-365/compliance/dlp-microsoft-teams)
