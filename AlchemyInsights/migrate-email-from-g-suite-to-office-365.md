...
メールを G Suite から Office 365 に移行するには、移行ツールを使って、メール、予定表、連絡先を移行します: [G Suite の移行を実行する](https://docs.microsoft.com/Exchange/mailbox-migration/perform-g-suite-migration)。
