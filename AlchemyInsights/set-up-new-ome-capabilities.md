...
- 新しい Office 365 Message Encryption 機能を設定するには、「[新しい OME 機能のセットアップ](/microsoft-365/compliance/set-up-new-message-encryption-capabilities)」を参照してください。

- 追加のサブスクリプションの詳細とよく寄せられる質問については、「[メッセージ暗号化に関する FAQ](/microsoft-365/compliance/ome-faq#what-subscriptions-do-i-need-to-use-the-new-ome-capabilities-)」を参照してください。
