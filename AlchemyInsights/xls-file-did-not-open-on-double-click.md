...
---
# <a name="setting-file-associations-back-to-defaults"></a>ファイルの関連付けを既定に戻す
...
**Office で開く Office ファイル拡張情報を設定するには、次のトラブルシューティングツールを実行します。**
