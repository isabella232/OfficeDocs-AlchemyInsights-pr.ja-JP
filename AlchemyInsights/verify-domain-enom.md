...
---
# <a name="verify-your-domain-with-google-enom"></a>web.com でドメインを確認する
...
詳しい手順については、「[Google がドメインを管理している場合に DNS レコードを作成する (eNom)](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-for-domain-managed-by-google-enom)」を参照してください。